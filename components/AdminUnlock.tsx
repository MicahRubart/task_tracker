  ...
  return (
    <>
      <button
        ...
        title={isAdmin ? "Admin mode — click to lock" : "Unlock admin mode"}
      ...
      {showModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
          <div className="bg-white rounded-xl shadow-xl p-6 w-80">
            <h2 className="text-base font-semibold text-gray-900 mb-4">Admin Login</h2>
            <form onSubmit={handleSubmit} className="space-y-3">
              ...
              <div className="flex gap-2">
                <button
                  type="submit"
                  className="flex-1 bg-indigo-600 text-white rounded-md py-2 text-sm font-medium hover:bg-indigo-700"
                >
                  Unlock
                </button>
                <button
